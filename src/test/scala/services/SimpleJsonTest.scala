...
/**
  ...
  */
class SimpleJsonTest extends FlatSpec with BeforeAndAfter with MockFactory
  with SimpleJson with testData {
  ...
  "ConvertJsonToPodcastSettings" should "be able to convert JSON to PodcastSettings" in {
